...
class BackendControllerTest extends AbstractBaseTest
{
    ...
    public function provideSuccessfulUrls()
    {
        return array(
            ...
            array('/admin/products/category/list'),
            array('/admin/products/category/create'),
            array('/admin/products/category/1/edit'),
            array('/admin/products/category/1/delete'),
            array('/admin/sliders/image/list'),
            array('/admin/sliders/image/create'),
